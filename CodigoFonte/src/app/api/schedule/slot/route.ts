...
import { getMeetingGroupSlots } from "@/app/services/external/ScheduleService";
...
export async function POST(request: NextRequest, context: any) {
  ...
  try {
    const data = await getMeetingGroupSlots(res.date, facilitador.cpf, res.class_id);
